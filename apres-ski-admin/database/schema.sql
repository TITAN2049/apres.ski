-- Drop existing tables if needed for cleanup (use carefully in development environments)
DROP TABLE IF EXISTS Users, EventsBands, EventsHosts, EventOrganizers, Events, CalendarEvents, CalendarTypes, Bands, EventSubcategories, EventCategories, Photos, Businesses, Towns, States CASCADE;
...
CREATE TABLE CalendarEvents (
    ...
    town_id INT,
    FOREIGN KEY (calendar_type_id) REFERENCES CalendarTypes(id) ON DELETE CASCADE,
